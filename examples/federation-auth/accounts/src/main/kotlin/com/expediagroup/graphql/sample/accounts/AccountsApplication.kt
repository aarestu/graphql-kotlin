...
package com.expediagroup.graphql.sample.accounts

import com.expediagroup.graphql.directives.KotlinDirectiveWiringFactory
import com.expediagroup.graphql.federation.FederatedSchemaGeneratorConfig
import com.expediagroup.graphql.federation.execution.FederatedTypeRegistry
import com.expediagroup.graphql.sample.accounts.directive.CustomDirectiveWiringFactory
import com.expediagroup.graphql.sample.accounts.extension.CustomFederatedSchemaGeneratorHooks
import com.expediagroup.graphql.sample.accounts.model.userResolver
...
class AccountsApplication {
    ...
    @Bean
    fun federatedTypeRegistry() = FederatedTypeRegistry(mapOf("User" to userResolver))
