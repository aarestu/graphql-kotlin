...
package com.expediagroup.graphql.sample.products

import com.expediagroup.graphql.directives.KotlinDirectiveWiringFactory
import com.expediagroup.graphql.federation.FederatedSchemaGeneratorConfig
import com.expediagroup.graphql.federation.execution.FederatedTypeRegistry
import com.expediagroup.graphql.sample.products.directive.CustomDirectiveWiringFactory
import com.expediagroup.graphql.sample.products.extension.CustomFederatedSchemaGeneratorHooks
import com.expediagroup.graphql.sample.products.model.productResolver
...
class ProductApplication {
    ...
    @Bean
    fun federatedTypeRegistry() = FederatedTypeRegistry(mapOf("Product" to productResolver))
